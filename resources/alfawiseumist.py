...
if args.action == 'on':
	...
	sock.sendto('{"command":"comm101","l_color":"'+args.options+'","deviceid":"'+args.deviceid+'","modelid":"sj07","phoneid":"020000000000","userid":""}', (args.deviceip, 10002))
elif args.action == 'read':
	sock.sendto('{"command":"comm1003","deviceid":""'+args.deviceid+'","modelid":"sj07","phoneid":"020000000000","userid":""}', (args.deviceip, 10002))
