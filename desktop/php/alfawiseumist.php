...
sendVarToJS('eqType', 'alfawiseumist');
$eqLogics = eqLogic::byType('alfawiseumist');
?>
<div class="row row-overflow">
  ...
  <div class="cursor" id="bt_healthalfawiseumist" style="background-color : #ffffff; height : 120px;margin-bottom : 10px;padding : 5px;border-radius: 2px;width : 160px;margin-left : 10px;" >
    <center>
...
<legend><i class="fa fa-table"></i>  {{Mes brumisateurs}}</legend>
<div class="eqLogicThumbnailContainer">
         <?php
                foreach ($eqLogics as $eqLogic) {
                    $opacity = '';
                    ...
                    echo "<center>";
                    echo '<img src="plugins/alfawiseumist/core/template/images/model.png" height="105" width="95" />';
                    echo "</center>";
...
<div class="col-sm-6">
  <center>
    <img src="plugins/alfawiseumist/core/template/images/model.png" style="height : 400px;" />
  </center>
</div>
</div>
</div>
...
<?php include_file('desktop', 'alfawiseumist', 'js', 'alfawiseumist'); ?>
